...
<img src="doc/images/translate.png" alt="划词翻译" width="400">

### 💬 AI 论文对话

在侧边栏与 AI 进行基于论文全文的智能对话，支持流式响应，实时查看 AI 回复。

<img src="doc/images/chat.png" alt="AI 对话" width="600">
...
将 Zotero 文献目录链接到对话中，让 AI 能够访问和搜索目录中的所有文献。

<img src="image/README/1772552105911.png" alt="文献目录引用" width="400">

- 点击「链接目录」按钮，选择要关联的 Zotero 文献目录
- AI 可以主动搜索目录中的相关文献来回答你的问题
- 在回答中引用文献时，自动提供文献标题和作者信息
- 适合需要综合多篇文献进行分析的场景
...
5. 点击「链接目录」关联文献目录，让 AI 访问更多相关文献
